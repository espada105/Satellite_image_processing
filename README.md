...
- **[프로젝트_기술_정리.md](./프로젝트_기술_정리.md)**: 채용 공고 요구사항 대응 기술 정리 (면접 준비용)
- **[면접_준비_요약.md](./면접_준비_요약.md)**: 면접 준비 요약 (핵심 메시지 및 예상 질문)
- `DATA_PROCESSING_GUIDE.md`: 데이터 처리 가이드
- `캡션_생성_가이드.md`: 캡션 생성 상세 가이드
- `프로젝트_구축_계획서.md`: 프로젝트 계획서
- `단계별_실행_가이드.md`: 단계별 실행 가이드
