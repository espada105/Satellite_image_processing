...
try:
    ...
    print("=" * 60)
    print("PostgreSQL 연결 테스트 (psycopg3)")
    print("=" * 60)
    ...
    print(f"❌ psycopg3가 설치되지 않았습니다.")
    print(f"오류: {e}")
    print(f"\n설치 명령어:")
    print(f"  pip install psycopg[binary]")
    print(f"  또는")
    print(f"  pip install psycopg3-binary")
